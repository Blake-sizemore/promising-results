...
2. In your JavaScript file, create a Promise chain that uses SlowMath to perform all of the following operations, in this exact order:
    1. Add together 6 and 2. - 8
    2. Wait on the result, log it, and then multiply the result by 2. - 16
    3. Wait on the result, log it, and then divide the result by 4. - 4
    4. Wait on the result, log it, and then subtract 3 from the result. - 1
    5. Wait on the result, log it, and then add 98 to the result. - 99 
    6. Wait on the result, log it, and then find the remainder from dividing the result by 2. - 49.5
    7. Wait on the result, log it, and then multiply the result by 50. -2475
    8. Wait on the result, log it, and then find the remainder from dividing the result by 40. -61.875
